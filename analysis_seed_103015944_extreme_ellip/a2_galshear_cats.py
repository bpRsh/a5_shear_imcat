...
#               psf10.par
#               weighted_psf.par
#               galshear # empty folder to write outputs
#                                 
# Outputs     : galshear/galshear_*.cat # for 100 lsst_*.fits, there will be 100
#                                         galshear_*.cat files.
#
# Info:
# 1. This program runs imcat commands on all the fitsfiles created by
#    jedisim program. This means:
#    It reads a. lsst_*.fits
#             b. 90_lsst_*.fits
#             c. monochromatic_*.fits
#             d. 90_monochromatic_*.fits
#
#    from the directory where we placed jedisim outputs.
#
#    This program also reads two paramters files: psf10.par and weighted_psf.par
#    from the current directory.
#
#    It runs imcat commands on all those jedisim output fitsfiles and create
#    catalogs for each of them galshear/galshear_*.cat
#
#
# 2. The parameter files psf10.par and weighted_psf.par are
#    created using a1_psf10_weighted_psf_par.py.
#
...
# Estimated time: 9 min 54 seconds for 131 loops.
...
# input/output folder
indir  = '/Users/poudel/jedisim_all_outputs/jedisim_out_seed_103015944_extreme_ellip'
outdir = 'galshear/' 



##=============================================================
# range is from 0 to last number + 1
